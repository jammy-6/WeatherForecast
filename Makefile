...
# Template: app
# Command: D:\Qt\5.15.2\msvc2019_64\bin\qmake.exe -o Makefile weather_forecast.pro -spec win32-msvc "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
clean: debug-clean release-clean  FORCE
	-$(DEL_FILE) weather_forecast.vc.pdb
	-$(DEL_FILE) weather_forecast.ilk
	-$(DEL_FILE) weather_forecast.idb
distclean: debug-distclean release-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) .qmake.stash weather_forecast.pdb
